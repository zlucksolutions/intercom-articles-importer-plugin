...
class ZIAI_Modules {
    ...
    {
        update_option('zl_taxonomy_get', $_POST['category']);
        update_option('zl_default_author', $_POST['author']);
        update_option('zl_post_type_get', $_POST['post_type']);
        update_option('zl_ziai_access_token', $_POST['api_key']);
